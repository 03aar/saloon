    ...
    <Page layout="app">
      ...
      <Sheet open={ready} onClose={() => setReady(false)} label="Offer ready">
        <div style={{ position: 'relative', paddingTop: 12 }}>
          ...
          <button type="button" onClick={() => toast('Escrow protects both parties', 'info')} style={{ display: 'flex', alignItems: 'center', gap: 16, width: '100%', textAlign: 'left', marginTop: 16, padding: '18px 20px', borderRadius: 22, background: 'var(--gold)', color: 'var(--ink)' }}>
